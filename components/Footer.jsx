...
export default function Footer() {
  ...
  return (
    <footer className="relative border-t border-white/[0.08] pt-16 md:pt-20 pb-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-16 mb-16 text-center md:text-left">
          {/* Brand */}
          <div className="md:col-span-1 flex flex-col items-center md:items-start">
            ...
            <p className="text-zinc-500 text-sm leading-[1.8] max-w-[240px] mx-auto md:mx-0">
              ...
              <ul className="space-y-3.5">
                {items.map((item) => (
                  <li key={item}>
                    <a
                      href="#"
                      className="inline-block text-zinc-500 hover:text-zinc-200 text-sm transition-colors duration-200"
                    >
                      {item}
                    </a>
                  </li>
        ...
        {/* Bottom bar */}
        <div className="border-t border-white/[0.05] pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-center">
